...
class ValetAutotune:
	...
	def __init__(self,structure,path_out=None,calculator=None):
		...
		if type(structure) == ase.atoms.Atoms:
			...
			print("Bad structure. Should be of type ase.atoms.Atoms.")
			return None
		if path_out is None:
			print("Please include the output directory as parameter `path_out`.")
			return None
		else:
			self.path['out'] = os.path.join('qv_workspace',path_out)
			if not os.path.isdir(path_out):
				os.system("mkdir -p {}".format(self.path['out']))
				print("Output directory created.")
		if calculator is None:
			print("Please attach calculators.")
			return None
		else:
			self.calculator = calculator
			self.calculator.set(directory=self.path['out'])
			self.structure['initial'].set_calculator(self.calculator)
			print("Calculator attached to structure.")
...
#    
#    
#    def __init__(self,structure,path_out=None,kpts=None,calculators=None):
#        # Initial structure handling
#        if type(structure) != ase.atoms.Atoms:
#            print("Input structure should be of type ase.atoms.Atoms")
#            return None
